const attributesPool = {
    ...
    backpack: ["Фонарь", "Генератор", "Вода (бутылка)", "Аптечка первой помощи", "Мультитул", "Карта", "Компас", "Защитный крем от солнца", "Зарядное устройство", "Солнечная батарея", "Теплый свитер", "Нож", "Лента (скотч)", "Портативная колонка", "Тканевая маска", "Блокнот и ручка", "Картриджи для фильтра воды", "Резервная батарея", "Перчатки", "Шарф", "Пластиковые пакеты", "Книга", "Лыжные перчатки", "Пончо", "Термос", "Спички в водонепроницаемом контейнере", "Зажигалка", "Запасные носки", "Запасные перчатки", "Плотная ткань (для укрытия)", "Аптечка с медикаментами", "Пластырь", "Туалетная бумага", "Мультитул с отвертками", "Резинка для волос", "Карандаш", "Параллельные батарейки", "Мешок для мусора", "Влажные салфетки", "Дождевик", "Пара солнцезащитных очков", "Фляга для воды", "Набор для чистки обуви", "Компактный коврик для сидения", "Шнурки", "Мешок для грязной одежды", "Налобный фонарь", "Набор для шитья", "Камера", "Лейкопластырь", "Стерео наушники", "Ветровка", "Плавательные очки", "Ловушка для насекомых", "Гриль для костра", "Картонные трубочки", "Тетрадь", "Пластиковая бутылка для воды", "Маска для сна", "Портативная плита", "Средство от комаров", "Ласты для плавания", "Лупа", "Термометр", "Держатель для телефона", "Бумажные стаканчики", "Пластиковая посуда", "Мел", "Зубная паста", "Дезодорант", "Блок для записей", "Антибиотики", "Леденцы от горла", "Пакет для замораживания", "Гель для рук", "Крем от ожогов", "Резиновая подушка", "Игрушка-антистресс", "Пластиковая чашка", "Увлажняющий крем", "Термометр для воды", "Плавник для снорклинга", "Салфетки для рук", "Зажигалка с несколькими функциями", "Мешок для белья", "Мелкие игрушки", "Компактная лопата", "Пачка сигарет", "Карманный вентилятор", "Спортивные бинты", "Губка для мытья посуды", "Леденцы", "Портативный зарядник", "Резиновая игрушка", "Блокнот для заметок", "Зубочистки", "Ушные палочки", "Картонный стаканчик", "Мешок для воды", "Шарик для стресса"],
    fact: ["Воровал у родных", "Скрывал семью", "Было 3 любовницы", "Хотел свою дочь", "Умеет тушить пожары", "Стримил на твиче"],
    moovea: ["Мут любого игрока"],
    moovem: ["Мут любого игрока"]
  };
  let usedAttributes = {
    profession: new Set(),
    hobby: new Set(),
